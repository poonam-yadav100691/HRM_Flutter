...
class ApiService {
  ...
  */
  ...
  Future<LeaveTypesResponse> leaveType({String url = ''}) async {
    ...
    List<dynamic> leavetype = apiResponse['data'];

    // List<LeaveTypes> todos = todoFromJson(json.encode(data));
    // String next = apiResponse['links']['next'];

    return LeaveTypesResponse(leavetype);
  }
